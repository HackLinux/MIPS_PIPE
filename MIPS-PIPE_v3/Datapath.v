 ...
 *
 *		- Os dois mux antes do PC serão controlados pelo sinal OrigPC:
 *			- 00: PC+4
...
assign wIFID_Flush = ((wCJump) | ((wCBranch) && (wEqual))) ? 1'b1 : 1'b0;
...
ALU ALUunit(
	.iCLK(iCLK),
	.Op(wALUControl),
	.A(wEX_ResultFowardA), //wEX_Read1
	.B(wEX_ResultOrigALU),
	.Out(wEX_ResultALU),
	.Zero(wEX_Zero),
	.Overflow(wEX_Overflow),
	.Shamt(wEX_Shamt)
);
